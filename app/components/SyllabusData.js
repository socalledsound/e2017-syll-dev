...
const SyllabusData =  {
	sessions: [

		{
			...
			// reading: "",
			assignment: "1. sign up for a tumblr account and send em an email with your tumblr handle.  READ Pauline Oliveros, 'Some Sound Observations'.",
			linkz: [
				{
			...
			tutorialz: [
				{
					linkText:"all about LEDs -- adafruit",
					linkSrc:"https://learn.adafruit.com/all-about-leds/overview"
				},
				{
					linkText:"everything about LEDs and current limiting",
					linkSrc:"https://www.youtube.com/watch?v=Qlayua3yjuE&index=23&list=PLAROrg3NQn7cyu01HpOv5BWo217XWBZu0&t=47s"	
				},
				{
					linkText:"an intro to LED strips",
					linkSrc:"http://www.instructables.com/id/Intro-to-LED-Strips/"	
				},
				{
					linkText:"dimming all kinds of LEDs",
					linkSrc:"https://www.youtube.com/watch?v=jQ3JHknsM4o&index=29&list=PLAROrg3NQn7cyu01HpOv5BWo217XWBZu0"
				},	
				{
					linkText:"blink an LED using javascript",
		...
		},	
		{
			...
			assignment: "Find an interesting place to make some recordings.  Record at least ten clips of audio using several different microphones and take at least ten pictures.  Shoot some video if you like, make some drawings, or document the space in any other way you think is appropriate,a s well.  READ Francisco Lopez",
			linkz: [
				{
		...
		
		{
			...
			description: "",
			// reading: "Arun Mehta, 'When A Button Is All That Connects You to The World'",
			assignment: "finish up those project 1!!!!",
			linkz: [
				{
		...
		},									
		{
			...
			},				
			{
					...
					linkz: [
						{
							linkText:"When a button is all that connects you with the world",
							linkSrc:"https://drive.google.com/file/d/0B2LpnVlBWDK2US03dkY4cFRaY0E/view"
						},
						{
							linkText:"google made a display out of buttons",
							linkSrc:"https://www.fastcompany.com/3060552/google-built-a-giant-display-out-of-arcade-buttons-and-its-amazing"
						},
						{
							linkText:"temporary services -- prisoner's inventions",
						...
						{
							linkText:"nytimes travel thing",
							linkSrc:"https://www.nytimes.com/interactive/2018/09/21/magazine/voyages-travel-sounds-from-the-world.html"
						},
						{
							linkText:"",
							linkSrc:""
					...
					tutorialz: [
						{
							linkText:"all about switches",
							linkSrc:"https://learn.sparkfun.com/tutorials/switch-basics"
						},
						{
							linkText:"video on buttons and switches",
				...
				},	
				{
					...
					day:2,
					date: "10/2",
					title: "All About LEDs",
					description:'',
					assignment: "",

					linkz: [
						{
							linkText:"Jim Campbell's led images swim through sapce",
							linkSrc:"https://www.youtube.com/watch?v=4x48aCX1uK8"
						},
						{
							linkText:"jenny holzer, nowness",
							...
							linkText:"Olafur Elliason, little sun",
							linkSrc:"https://littlesun.com/"
						},	
						{
							linkText:"leo villareal light and code as medium",
							linkSrc:"https://www.youtube.com/watch?v=aQWYvzwXkkM"
						},												
						{
							linkText:"James Turrell",
							linkSrc:"http://jamesturrell.com/"
						},
						{
							linkText:"Dan Flavin",
							linkSrc:"https://www.google.com/search?q=Dan+Flavin&stick=H4sIAAAAAAAAAONgFuLSz9U3MDFPyjHMUOIEsQ3LjXIttPgCUouK8_OCM1NSyxMriwFqFqiZKQAAAA&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjUuvL50ePdAhVaGDQIHViyBRkQ_AUIDigB&biw=1220&bih=913"
						},
{
							linkText:"",
							linkSrc:""
					...
					tutorialz: [
						{
							linkText:"ada fruit all about leds",
							linkSrc:"https://learn.adafruit.com/all-about-leds/overview"
						},
						{
							linkText:"an intro to LED strips",
							linkSrc:"https://www.instructables.com/id/Intro-to-LED-Strips/"
						},					{
							linkText:"blinking an LED with javascript and a raspberry pi",
							linkSrc:"https://www.instructables.com/id/JavaScript-for-IoT-Blinking-LED-on-Raspberry-Pi-Wi/"
						},
						{
							linkText:"everything about LEDs and current limiting",
							linkSrc:"https://www.youtube.com/watch?v=Qlayua3yjuE&index=23&list=PLAROrg3NQn7cyu01HpOv5BWo217XWBZu0&t=47s"
				...
				},	
				{
					...
					tutorialz: [
						{
							linkText:"p5 code: nested loops -- pixels",
							linkSrc:"https://editor.p5js.org/socalledsound/sketches/r1tqhyMqm"
						},
						{
							linkText:"p5code: more pixels",
							linkSrc:"https://editor.p5js.org/socalledsound/sketches/rkg7akfc7"
						},
						{
							linkText:"p5 code: low res nyan image",
							linkSrc:"https://editor.p5js.org/socalledsound/sketches/Sk5MygM5m"
						},
						{
		...
		// 			linkz: [
		// 				{
		// 					linkText:"Deleuze, 'The Dice Throw'",
		// 					linkSrc:"https://drive.google.com/open?id=0B2LpnVlBWDK2cFpYTUFzeXNUSkE"
		// 				},
		// 				{
		// 					linkText:"Kim Cascone, 'The Aesthetics of Failure'",
		// 					linkSrc:"http://subsol.c3.hu/subsol_2/contributors3/casconetext.html"
		// 				},
		// 				{
		// 					linkText:"Marcia Tucker on John Baldessari",
		// 					linkSrc:"readings/marciaTucker-baldessariUnpredictable.pdf"
		// 				},
		// 				{
		...
		// 				},							
		// 				{
		// 					linkText:"10_print_chr_205_5_rnd_1_goto_10",
		// 					linkSrc:"http://www.slate.com/articles/technology/books/2012/11/computer_programming_10_print_chr_205_5_rnd_1_goto_10_from_mit_press_reviewed.html"
		// 				},
		// 				{
		// 					linkText:"javascript maze generator in a single tweet",
		// 					linkSrc:"https://www.reddit.com/r/programming/comments/3iy6fk/javascript_maze_generator_in_a_tweet/"
		// 				},
		// 				{
		// 					linkText:"jodi.org",
		// 					linkSrc:"http://wwwwwwwww.jodi.org/"
		...
		// 			tutorialz: [
		// 				{
		// 					linkText:"random values, p5.js",
		// 					linkSrc:"https://p5js.org/examples/math-random.html"
		// 				},
		// 				{
		// 					linkText:"random whole numbers from free code camp",
		// 					linkSrc:"https://www.freecodecamp.com/challenges/generate-random-whole-numbers-with-javascript"
		// 				},
		// 				{
		// 					linkText:"2.5: The random() Function - p5.js Tutorial",
		...
		// 				{
		// 					linkText:"Steve Reich, 'Music As A Gradual Process'",
		// 					linkSrc:"https://drive.google.com/open?id=0B2LpnVlBWDK2S3FnR3U3bjBnTHM"
		// 				},
		// 				{
		// 					linkText:"steve reich, pendulum music performance",
		// 					linkSrc:"https://www.youtube.com/watch?v=7qEVywKMRLg"
		// 				},
		// 				{
		// 					linkText:"Physicist of Sound | Carsten Nicolai",
		// 					linkSrc:"https://www.youtube.com/watch?v=zCBIKXFrfNA"
		// 				},
		// 				{
		...
		// 				},
		// 				{
		// 					linkText:"100 days of click art, Leslie Ruckman",
		// 					linkSrc:"https://leslieruckman.tumblr.com/"
		// 				},
		// 				{
		// 					linkText:"Nyan Cat 10 hours (original)",
		// 					linkSrc:"https://www.youtube.com/watch?v=wZZ7oFKsKzY"
		// 				},
		// 				{
...
// 				// },	
				...
				},	
		{
					...
					linkz: [
						...
						},
						{
							...
							linkSrc:"https://www.nytimes.com/interactive/2017/04/02/technology/100000005019770.mobile.html?_r=0"
						},
						{
				...
				},											
		{
					...
					linkz: [
						{
							linkText:" Deleuze and Guattari, 1000 Plateaux (excerpt)",
							linkSrc:"https://drive.google.com/open?id=0B2LpnVlBWDK2XzJieFU3bTNJV2c"
						},
						{
							linkText:"",
							linkSrc:""
